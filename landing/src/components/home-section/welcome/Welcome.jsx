        ...
        <div className="welcome__info relative">
            <div className="welcome__info__content">
                ...
                <div className="description m-t-4">
                    Team up with friends and test your skillsin 5v5 MOBA combat. All the height-skill
                    competition you crave, desing especailly for mobile and console with revamped controls
                    and stremlined matches. Explore the living universe of Runeterra through lore, comics,
                    games, cosplayers, musicians, and content creators who are waiting for you yo join them.
                </div>
